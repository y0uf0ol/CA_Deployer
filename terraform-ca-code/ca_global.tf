...
resource "azuread_conditional_access_policy" "ca024" {
  display_name = "CA024-Global-IdentityProtection-AllApps-AllPlatforms-AuthFlows-Block"
...
resource "azuread_conditional_access_policy" "ca023" {
  display_name = "CA023-Global-AttackSurfaceReduction-AllApps-RiskyLocations-Block"
  state        = "enabledForReportingButNotEnforced"
  ...
  conditions {
    ...
    locations {
      included_locations = [azuread_named_location.block_location.id]
      excluded_locations = []
    }
  }
...
resource "azuread_conditional_access_policy" "ca022" {
  display_name = "CA022-Global-AttackSurfaceReduction-AllApps-UnallowedPaltforms-Block"
  state        = "enabledForReportingButNotEnforced"
...
resource "azuread_conditional_access_policy" "ca021" {
  display_name = "CA021-Global-IdentityProtection-LegacyAuth-AllPlatforms-Block"
  state        = "enabledForReportingButNotEnforced"
...
resource "azuread_conditional_access_policy" "ca020" {
  display_name = "CA020-Global-IdentityProtection-AllApps-AllPlatforms-CombinedRegistration-RequireMFA"
  state        = "enabledForReportingButNotEnforced"
